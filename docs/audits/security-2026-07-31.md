...
> Historical snapshot: this report describes the repository and working tree as
> reviewed on 2026-07-31. Status statements are not assertions about the current
> tree; use the repository's current security and supply-chain gates for present
> release decisions.
