...
> Historical implementation audit. Its validation and blocker statements describe
> the 2026-09-04 snapshot. The JXR dependency reviews have since been recorded;
> consult [SUPPLY_CHAIN.md](../../SUPPLY_CHAIN.md) and current release checks for
> release readiness.
