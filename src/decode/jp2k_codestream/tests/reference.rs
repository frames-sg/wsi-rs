//! Test-only pre-migration oracle for fixture metadata and legacy validation cases.
...
pub(crate) enum Jp2kProgressionOrder {
    Lrcp,
    Rlcp,
    Rpcl,
    Pcrl,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(crate) enum Jp2kWaveletTransform {
    Irreversible9x7,
    Reversible5x3,
    Unknown(u8),
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(crate) enum Jp2kQuantizationStyle {
    NoQuantization,
    ScalarDerived,
    ScalarExpounded,
    Reserved(u8),
...
pub(crate) struct Jp2kComponentInfo {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct Jp2kCodingStyleInfo {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct Jp2kQuantStep {
    pub exponent: u8,
    pub mantissa: u16,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct Jp2kQuantizationInfo {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct Jp2kTilePartHeader {
    pub tile_index: u16,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct Jp2kTilePartInfo {
...
impl Jp2kCodingStyleInfo {
    ...
    pub(crate) fn expected_expounded_quant_steps(&self) -> usize {
